...
const Contact = () => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs
        .sendForm('service_025gg9o', 'template_2eczol8', form.current, {
          publicKey: 'i3a-9HNRMzNUZRwyo',
        })
       e.target.reset()
    };
                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">andres.dx23@gmail.com</span>

                            <a href="" className="contact__button"> Escribeme{" "} <i className="bx bx-right-arrow-alt
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">+593 999068118  </span>
 ...
 contact__button-icon"></i></a>
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">Andres Serrano  </span>
...
contact__button-icon"></i></a>
                ...
                <div className="contact__content">
                    ...
                    <h3 className="contact__title">Escribeme un mensaje</h3>
                    <form ref={form} onSubmit={sendEmail} className="contact__form">
                        ...
                        <div className="contact__form-div contact__form-area">
                            ...
                            <textarea name="message" className="contact__form-input" placeholder="Escribe tu mensaje"
